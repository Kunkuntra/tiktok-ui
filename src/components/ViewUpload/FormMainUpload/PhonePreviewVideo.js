...
import Base64Convert from '~/services/convertBase64ToBlob';
      ...
      reader.onload = (event) => {
        setTimeout(async () => {
          try {
            ...
            const blobUrl = await Base64Convert(base64, 'video/mp4');
          ...
          <div className={cx('phone-preview')}>
            ...
            <div className={cx('controller')}>
              <div className={cx('controller-video')}>
                <div className={cx('actions-control')}>
                  ...
                  <div>
                    <VolumeVideo isMute={muteVideo} onClick={handleMuteVideo} width="1.6rem" heigth="1.6rem" />
                  </div>
                </div>
            ...
            <div className={cx('phone-video')}>
              <div className={cx('card-video')}>
                <video ref={videoRef} onEnded={handleEndedVideo} className={cx('video')} src={isFile} preload="auto" />
              </div>
            </div>
          </div>
